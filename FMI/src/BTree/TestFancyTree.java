...
public class TestFancyTree {
  	...
  	public static void main(String[] args) {
   		try {
    		...
    		BinaryTree tree = new FancyTree(new BinarySearchTree(new NaturalComparator()));
			...
			System.out.println("Test and write results to the file " + target);   			
    		tree = new FancyTree(new BinarySearchTree(new EntryComparator());
